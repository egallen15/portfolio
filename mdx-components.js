      ...
      <div className='container flex flex-col justify-center mb-6 lg:mb-0 mx-auto'>
        <div className="container flex flex-col lg:flex-row justify-center">
          <div className="w-auto max-w-[48rem]">
            ...
            <article className="w-auto prose leading-relaxed lg:leading-[1.75] dark:prose-invert mb-6 mx-6 md:mx-0 prose-img:rounded-xl marker:text-sky-600 dark:marker:text-sky-400">
              {children}
            </article>
