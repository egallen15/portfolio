...
author: "Jane Doe"
date: "2025-02-03"
image: "https://placehold.co/1792x770?text=Dummy+Markdown"
excerpt: "A dummy markdown post with example content and formatting."
...
```ts {2} /return/ copy showLineNumbers filename="demo.ts"
