...
const AboutPageClient: React.FC = () => {
  ...
  const timelineEvents: TimelineEvent[] = [
    ...
    },
    {
      ...
      description:
        "UX internship led to full-time design role; redesigned Subsplash push notifications &Giving features.",
      side: "right",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      description:
        "Designed 1UX, mobile app concepts, & reporting for Subsplash Check-in.",
      side: "left",
    },
    {
      id: 10,
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center lg:items-center pb-8">
      <div className="w-full lg:max-w-7xl px-6 lg:px-0">
        <Breadcrumb
      ...
      <main className="px-6 w-full max-w-7xl flex flex-col lg:px-0 backdrop-blur-sm rounded-md">
        ...
        <div className="relative">
          ...
          <p className="prose dark:prose-invert md:pt-8 lg:text-[17px] lg:leading-7">
            I&#39;m Eric—a designer, builder, and writer living in Austin,
            Texas.
          </p>
          <p className="prose dark:prose-invert pt-6 lg:text-[17px] lg:leading-7">
        ...
        <ul className="prose dark:prose-invert pt-6 list-disc list-inside lg:text-[17px] lg:leading-7">
        ...
        <hr className="w-full border-slate-200 dark:border-slate-700 my-8" />
        <h3 className="relative inline-block text-2xl font-bold pt-4">
          My journey
        </h3>
