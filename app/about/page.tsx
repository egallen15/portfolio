  ...
  const timelineEvents: TimelineEvent[] = [
    {
      ...
      description:
        "Joined as Platform Specialist, solving tickets and taking customer service calls.",
      side: "left",
    },
    {
      id: 2,
      date: "Fall 2018",
      title: "Redesigned platform onboarding",
      description: "Project was key contributor to improved NPS up to 40",
      side: "right",
    },
    {
      id: 3,
      ...
      description:
        "Lead UX designer on a church payment system. $40M processed in first 2 years",
      side: "left",
    },
    {
      id: 4,
      date: "2020",
      title: "Simplify platform signup",
      description:
        "Reduced time to complete by 90%, modernized design, integrated with Stripe, Salesforce, Netsuite",
      side: "right",
    },
    {
      id: 5,
      date: "2020",
      title: "PM + UX on Event Registration",
      description:
        "Led design, strategy, and delivery for Subsplash Event Registration",
      side: "left",
    },
    {
      id: 6,
      date: "2020",
      title: "Placeholder Event 6",
