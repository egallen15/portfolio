  ...
  if (!params.mdxPath || params.mdxPath.length === 0) {
    return (
      <main className="w-full mx-6 mb-6 max-w-7xl xl:mx-0">
        ...
        <BlogContentServer
          rssButton={
            <div className="contents sm:flex sm:w-auto sm:flex-wrap sm:items-center sm:justify-end sm:gap-3">
              <NewsletterSubscription compact className="col-span-2 row-start-2 w-full sm:col-span-auto sm:row-auto sm:w-auto" />
              <Link
                href="/feed.xml"
                className="col-start-2 row-start-1 flex h-12 items-center gap-2 px-3 text-sm bg-transparent hover:bg-slate-100 dark:hover:bg-slate-800 rounded-md transition-colors"
                target="_blank"
