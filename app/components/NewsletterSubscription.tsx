        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <input
            ...
            onChange={(e) => setEmail(e.target.value)}
              ...
              className="flex-1 px-4 py-3 max-w-md text-gray-900 dark:text-white bg-gray-100 dark:bg-gray-800 dark:border dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            disabled={isLoading}
