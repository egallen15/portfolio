      ...
      <div className="w-full max-w-screen-xl mx-auto mb-6 px-6 xl:px-0 md:py-8">
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8 mb-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 xl:col-span-2">
            <div>
              <h3 className="text-sm font-semibold text-slate-900 dark:text-white mb-4">About</h3>
            ...
            <div>
              <h3 className="text-sm font-semibold text-slate-900 dark:text-white mb-4">Products</h3>
              <ul className="space-y-3">
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <div className="relative group w-full mt-6 md:mt-0 md:w-auto md:order-1">
              ...
              <span className="inline-block text-sm ml-7 text-slate-500">
                ...
                <Link href="https://ericallenux.com" className="hover:underline">
                  Eric Allen UX
                </Link>
                . All Rights Reserved.
              </span>
