...
const CaseStudyListItem: React.FC<CaseStudyListItemProps> = ({
    ...
    return (
        <Link href={linkHref} className={`flex flex-col md:flex-row items-center mb-8 p-6 md:p-8 no-underline rounded-lg overflow-hidden hover:bg-gradient-to-tr hover:from-slate-300/30 hover:to-sky-300/30 dark:hover:bg-gradient-to-tr dark:hover:from-slate-400/30 dark:hover:to-sky-700/30 ${className}`}>
