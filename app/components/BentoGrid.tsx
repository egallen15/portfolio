...
export default function BentoGrid({ maxItems }: BentoGridProps) {
  ...
  const allProjects: BentoGridItem[] = [
    ...
    {
      id: "household-statements",
      action: "lightbox",
      title: "Household Giving Statements",
      date: "January - June 2025",
      description: "A combined household giving statement flow for donor tax statements.",
      image: "https://ericallen.info/images/household-statements.png",
      imageAlt: "Household giving statement document and selection interface",
      imageWidth: 2103,
      imageHeight: 1665,
      lightboxImage: {
        src: "https://ericallen.info/images/household-statements.png",
        alt: "Household giving statement document and selection interface",
        width: 2103,
        height: 1665,
      },
    ...
    },
    {
      ...
      date: "January - June 2025",
      description: "A discount code management interface for event registration promotions.",
      image: "https://ericallen.info/images/discount-codes.png",
      imageAlt: "Discount codes management interface",
      imageWidth: 1551,
      imageHeight: 1044,
      lightboxImage: {
        src: "https://ericallen.info/images/discount-codes.png",
        alt: "Discount codes management interface",
        width: 1551,
        height: 1044,
      },
